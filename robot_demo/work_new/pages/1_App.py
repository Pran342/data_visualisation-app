...
def init_session():
    session_keys = {
        ...
        "show_left_panel": True,  # left
        "show_right_panel": True  # right
    }
...
def main():
    ...
    st.markdown("<h1 style='text-align: center;'>🤖 Robot Capability Event Flow Analysis System</h1>", unsafe_allow_html=True)
    ...
    left_width = 3.5 if st.session_state.show_left_panel else 0.1
    right_width = 3.5 if st.session_state.show_right_panel else 0.1
    main_width = 14 - left_width - right_width  # Total width remains 14 (Streamlit default)

    
    col1, col2 = st.columns([ main_width, right_width])
